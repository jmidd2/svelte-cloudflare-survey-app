...
export const buttonVariants = tv({
  ...
  variants: {
    variant: {
      ...
      destructive:
        'bg-destructive shadow-xs focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60 text-white hover:bg-destructive/70 dark:hover:bg-destructive/90',
      outline:
